"""
Seed AGS backend with multi-city cinemas, screens, seats, movies, showtimes.
"""
...
CINEMAS: list[dict] = [
    {"name": "AGS T. Nagar",    "screens": 3},
    {"name": "AGS Villivakkam", "screens": 3},
    {"name": "AGS Maduravoyal", "screens": 3},
]
CHAIN_CITY = "Chennai"
...
def seed(db_url: str | None = None) -> None:
    ...
    print(
        f"AGS seeded: {len(CINEMAS)} cinemas in {CHAIN_CITY}, "
